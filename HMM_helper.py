...
def states_to_wordclouds(hmm, obs_map, mapping, mapping_r, rhyme_dic, stress_dic, max_words=50, show=True):
    # Initialize.
    M = 10
    n_states = len(hmm.A)
    ...
    # M, mapping, mapping_r, rhyme, rhyme_dic, stress_dic
    emission, states = [], []
    for i in range (100):
        rhyme = random.choice(list(rhyme_dic.keys()))
        e, s = hmm.generate_emission_rhyme_meter(M, mapping, mapping_r, rhyme rhyme_dic, stress_dic)
        emision.append(e)
        states.append(s)
